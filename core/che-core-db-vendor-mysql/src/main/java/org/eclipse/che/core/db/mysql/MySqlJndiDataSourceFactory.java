 ...
 */
package org.eclipse.che.core.db.mysql;
...
/**
 * Environment params based JNDI data source factory for MySQL.
 *
 * @author Mykhailo Kuznietsov
 */
public class MySqlJndiDataSourceFactory extends JNDIDataSourceFactory {

  private static final String DEFAULT_USERNAME = "";
  private static final String DEFAULT_PASSWORD = "";
  private static final String DEFAULT_URL = "jdbc:mysql:che";
  private static final String DEFAULT_DRIVER__CLASS__NAME = "com.mysql.jdbc.Driver";
  ...
  public MySqlJndiDataSourceFactory() throws Exception {
    super(
        firstNonNull(
