...
public class WorkingWithSplitPanelTest {
    ...
    public void checkMultiSplitPane() {
        ...
        multiSplitPanel.waitProcessIsNotPresentIntoPaneMenu(MultiSplitPanel.SplitPaneCommands.CLOSE_PANE);
        multiSplitPanel.clickOnIconMultiSplitPanel(3);
        multiSplitPanel.waitSplitPanelMenuIsOpen();
    ...
    public void checkTerminalAndBuild() {
        ...
        commandsBuilder(TestIntelligentCommandsConstants.CommandsGoals.COMMON_GOAL, TestIntelligentCommandsConstants.CommandsTypes.MAVEN_TYPE);
    ...
    public void checkTabsOnSplitPanel() {
        ...
        multiSplitPanel.waitMesageIntoSplitGitPanel(2, " On branch master\n" + " Changes not staged for commit");
    ...
    public void checkSwitchingTabsAndPanels() {
        ...
        multiSplitPanel.waitTabNameProcessIsFocused("Git status");
        multiSplitPanel.waitMesageIntoSplitGitPanel(1, " On branch master\n" + " Changes to be committed");
