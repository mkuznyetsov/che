...
public class ResolveDependencyAfterRecreateProjectTest {
    private static final String NAME_OF_THE_PROJECT_1 = NameGenerator.generate("ResolveDependencyAfterRecreateProject", 4);
    private static final String NAME_OF_THE_PROJECT_2 = NameGenerator.generate("ResolveDependencyAfterRecreateProject", 4);
    private static final String PATH_FOR_EXPAND       = "/src/main/java/org/eclipse/che/examples/GreetingController.java";
