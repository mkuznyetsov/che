...
public class CheckCollapseAllNodesProjectTest {
    ...
    public void checkCollapseAllBtnProjectTree() throws Exception {
        ...
        projectExplorer.waitDisappearItemByPath(PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples/AppController.java");
        projectExplorer.waitDisappearItemByPath(PROJECT_NAME + "/src/test/java/org/eclipse/qa/examples/AppControlleTest.java");
        editor.waitTabIsPresent("AppController");
        editor.waitTabIsPresent("AppControlleTest");
    }
}
