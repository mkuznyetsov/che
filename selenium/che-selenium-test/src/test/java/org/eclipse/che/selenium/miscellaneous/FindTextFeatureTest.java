...
public class FindTextFeatureTest {
    ...
    private static final String FIND_NOTHING =
            "(0 occurrence)";

    private static final String PR_1_EXPECTED_TEXT_1 =
            "(4 occurrences)\n" +
            "AppController.java\n" +
            "(/" + PROJECT_NAME + "/my-webapp/src/main/java/org/eclipse/qa/examples/AppController.java)\n" +
            "SayHello.java\n" +
            "(/" + PROJECT_NAME + "/my-lib/src/main/java/hello/SayHello.java)\n" +
            "SayHelloTest.java\n" +
    ...
    private static final String PR_3_PATH_1          = PROJECT_NAME + "/my-webapp/src/main/java/org/eclipse/qa/examples";
