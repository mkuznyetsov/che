...
public class CheckMavenPluginTest {
    ...
    @Inject
    private AskForValueDialog        askDialog;
    @Inject
    private Git                      git;
    @Inject
    ...
    @Inject
    private TestCommandServiceClient commandServiceClient;
    ...
    public void shouldExecuteCommandAndWaitTextInConsole() throws Exception {
        projectExplorer.invokeCommandWithContextMenu(ProjectExplorer.CommandsGoal.COMMON, PROJECT_NAME, CHECKOUT_COMMAND);
    ...
    public void excludeIncludeModules() {
        ...
        projectExplorer.waitFolderDefinedTypeOfFolderByPath(PROJECT_NAME + "/my-lib", ProjectExplorer.FolderTypes.SIMPLE_FOLDER);
        ...
        projectExplorer.waitFolderDefinedTypeOfFolderByPath(PROJECT_NAME + "/my-lib", ProjectExplorer.FolderTypes.PROJECT_FOLDER);
     ...
     *         name of the file
     * @param item
     *         the type of item in the create file widget
     * @param fileExt
     *         the extension of file for checking in the Project explorer tree
     */
    private void createNewFileFromMenuFile(String name, AskForValueDialog.JavaFiles item, String fileExt) {
        menu.runCommand(TestMenuCommandsConstants.Project.PROJECT, TestMenuCommandsConstants.Project.New.NEW, TestMenuCommandsConstants.Project.New.JAVA_CLASS);
        loader.waitOnClosed();
