...
public class CheckRecentFilesAndRevealResourceTest {
    ...
    private static final String PATH_TO_FILE_FIRST_PROJECT     = FIRST_PROJECT_NAME +
                                                                 "/src/main/java/org/eclipse/qa/examples/AppController.java";
    private static final String PATH_TO_FILE_SECOND_PROJECT    = SECOND_PROJECT_NAME +
                                                                 "/src/main/java/org/eclipse/qa/examples/AppController.java";
    private static final String PATH_FOR_EXPAND_FIRST_PROJECT  = FIRST_PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples";
    private static final String PATH_FOR_EXPAND_SECOND_PROJECT = SECOND_PROJECT_NAME + "/src/main/java/org/eclipse/qa/examples";
    ...
    public void checkRecentFilesTest() {
        ...
        loader.waitOnClosed();
        projectExplorer.quickRevealToItemWithJavaScript(
                PATH_FOR_EXPAND_SECOND_PROJECT);
        ...
        editor.closeAllTabs();
        menu.runCommand(TestMenuCommandsConstants.Edit.EDIT,
                        TestMenuCommandsConstants.Edit.OPEN_RECENT_FILE);
