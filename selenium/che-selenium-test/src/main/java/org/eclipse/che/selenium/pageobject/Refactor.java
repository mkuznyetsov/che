...
public class Refactor {
    ...
    private interface Locators {
        ...
        String RENAME_COMPILATION_UNIT_FORM = "//div[text()='Rename Compilation Unit']/ancestor::div[3]";
        ...
        String MOVE_DESTINATION_FOR_ITEM = "//div[text()='Choose destination for']//following::div[text()=' %s']";
        ...
        String TEXT_MESSAGE_MOVE_FORM              = "//div[text()='Move item']/parent::div/parent::div/parent::div//div[text()='%s']";
    ...
    @FindBy
            (xpath = Locators.RENAME_PACKAGE_FORM)
    WebElement renamePackageForm;

    @FindBy
            (xpath = Locators.RENAME_JAVA_CLASS_FORM)
    WebElement renameJavaClass;

    @FindBy
            (xpath = Locators.RENAME_METHOD_FORM)
    WebElement renameMethodForm;

    @FindBy
            (xpath = Locators.RENAME_PARAMETERS_FORM)
    WebElement renameParametersForm;

    @FindBy
            (xpath = Locators.MOVE_ITEM_FORM)
    WebElement moveItemForm;

    @FindBy
            (xpath = Locators.RENAME_FIELD_FORM)
    WebElement renameFieldForm;

    @FindBy
            (id = Locators.REFACTOR_PREVIEW_BUTTON)
    WebElement previewRefactorButton;

    @FindBy
            (id = Locators.REFACTOR_CANCEL_BUTTON)
    WebElement cancelRefactorButton;

    @FindBy
            (id = Locators.REFACTOR_OK_BUTTON)
    WebElement okRefactorButton;

    @FindBy
            (xpath = Locators.PREVIEW_FORM)
    WebElement previewRefactorForm;

    @FindBy
            (id = Locators.PREVIEW_OK_BUTTON)
    WebElement previewOkButton;

    @FindBy
            (xpath = Locators.UPDATE_REFERENCES_CHECKBOX_SPAN)
    WebElement updateReferencesCheckBoxSpan;

    @FindBy
            (xpath = Locators.UPDATE_REFERENCES_CHECKBOX)
    WebElement updateReferencesCheckBox;

    @FindBy
            (xpath = Locators.UPDATE_VARIABLES_METHODS_CHECKBOX)
    WebElement updateVarMethodsBox;

    @FindBy
            (xpath = Locators.RENAME_SUBPACKAGES_CHECKBOX_SPAN)
    WebElement renameSubpackagesCheckBoxSpan;

    @FindBy
            (xpath = Locators.RENAME_SUBPACKAGES_CHECKBOX)
    WebElement renameSubpackagesCheckBox;

    @FindBy
            (xpath = Locators.UPDATE_COMMENTS_STRINGS_CHECKBOX)
    WebElement updateCommentAndStringsBox;

    @FindBy
            (xpath = Locators.UPDATE_COMMENT_STRING_CHECKBOX_SPAN)
    WebElement updateCommentAndStringBoxSpan;

    @FindBy
            (xpath = Locators.UPDATE_NON_JAVA_FILES_CHECKBOX_SPAN)
    WebElement updateNonJavaFilesBoxSpan;

    @FindBy
            (xpath = Locators.UPDATE_NON_JAVA_FILES_CHECKBOX)
    WebElement updateNonJavaFilesBox;

    @FindBy
            (xpath = Locators.NEW_NAME_FIELD)
    WebElement newNameFileInput;

    @FindBy
            (xpath = Locators.NAME_PATTERNS_FIELD)
    WebElement namePatternsInput;


    @FindBy
            (xpath = Locators.RENAME_COMPILATION_UNIT_FORM)
    WebElement renameCompilationUnit;

    @FindBy
            (xpath = Locators.LEFT_EDITOR)
    ...
    public void waitRenamePackageFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(renamePackageForm));
    }
    ...
    public void waitRenamePackageFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated
    ...
    public void waitRenameMethodFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(renameMethodForm));
    }
    ...
    public void waitRenameMethodFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, ELEMENT_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated
                (By.xpath(Locators.RENAME_METHOD_FORM)));
    }
    ...
    public void waitRenameFieldFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(renameFieldForm));
    }
    ...
    public void waitRenameFieldFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated
                (By.xpath(Locators.RENAME_FIELD_FORM)));
    }
    ...
    public void waitMoveItemFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(moveItemForm));
    }
    ...
    public void waitMoveItemFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.invisibilityOfElementLocated
                (By.xpath(Locators.MOVE_ITEM_FORM)));
    }
    ...
    public void clickOnExpandIconTree(String name) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(Locators.MOVE_EXPAND_TREE_ICON, name)))).click();
    ...
    public void chooseDestinationForItem(String name) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.MOVE_DESTINATION_FOR_ITEM, name)))).click();
    }
    ...
    public void clickCancelButtonRefactorForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.elementToBeClickable
                (cancelRefactorButton)).click();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.REFACTOR_CANCEL_BUTTON)));
    }
    ...
    public void clickOkButtonRefactorForm() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(activeStateLocator))).click();
        loader.waitOnClosed();
    }
    ...
    public void clickOnUpdateReferencesCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf
                (updateReferencesCheckBoxSpan)).click();
    }
    ...
    public void waitUpdateReferencesIsSelected() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(Locators.UPDATE_REFERENCES_CHECKBOX), true));
    }
    ...
    public void waitUpdateReferencesIsNotSelected() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(Locators.UPDATE_REFERENCES_CHECKBOX), false));
    }
    ...
    public void clickOnRenameSubpackagesCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(renameSubpackagesCheckBoxSpan)).click();
    }
    ...
    public void waitRenameSubpackagesIsSelected() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(Locators.RENAME_SUBPACKAGES_CHECKBOX), true));
    }
    ...
    public void waitRenameSubpackagesIsNotSelected() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(Locators.RENAME_SUBPACKAGES_CHECKBOX), false));
    }
     ...
     *
     * @param state
     *         state of checkbox (true if checkbox must be selected)
     */
    ...
    public void clickOnUpdateCommentsAndStringsCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(updateCommentAndStringBoxSpan)).click();
    }
    ...
    public void waitUpdateCommentsAndStringsIsSelected() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(locator), true));
    }
    ...
    public void waitUpdateCommentsAndStringsIsNotSelected() {
        String locator = Locators.UPDATE_COMMENTS_STRINGS_CHECKBOX;
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.xpath(locator), false));
    }
    ...
    public void clickOnUpdateNonJavaFilesCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(updateNonJavaFilesBoxSpan)).click();
    }
    ...
    public void typeNewName(String newValue) {
        try {
            new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                    (ExpectedConditions.visibilityOf(newNameFileInput)).clear();
            loader.waitOnClosed();
    ...
    public void sendKeysIntoField(String keys) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(newNameFileInput)).sendKeys(keys);
        loader.waitOnClosed();
    }
     ...
     *
     * @param expectedName
     *         expected name in new name field
     */
    public void waitTextIntoNewNameField(final String expectedName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)
                                                                                      webDriver -> seleniumWebDriver.findElement(
                                                                                              By.xpath(Locators.NEW_NAME_FIELD))
                                                                                                      .getAttribute("value")
                                                                                                      .equals(expectedName));
    }
    ...
    public void typeFileNamePatterns(String fileName) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(namePatternsInput)).clear();
    ...
    public void waitTextInErrorMessage(String mess) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.textToBePresentInElementLocated(
    ...
    public void waitRefactorPreviewFormIsOpened() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.visibilityOf(previewRefactorForm));
    }
    ...
    public void waitRefactorPreviewFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.PREVIEW_FORM)));
    }

    /**
     * click on item by name or part of the name and number of position
    ...
    public void clickOnItemByNameAndPosition(String nameItem, int position) {
        List<WebElement> itemList = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions
                               .presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.ITEM_CHANGES_TO_BE_PERFORMED, nameItem))));
    ...
    public void checkTextFromLeftEditor(String expectedText) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(
                By.xpath(Locators.PREVIEW_EDITOR_FRAME)));
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(
                ExpectedConditions.textToBePresentInElementLocated(By.xpath(Locators.LEFT_EDITOR), expectedText));
    ...
    public void checkTextFromRightEditor(String expectedText) {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(
                By.xpath(Locators.PREVIEW_EDITOR_FRAME)));
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(
                ExpectedConditions.textToBePresentInElementLocated(By.xpath(Locators.RIGHT_EDITOR), expectedText));
        seleniumWebDriver.switchTo().parentFrame();
    }

    /**
     * Click on expand item by name or part of the name and number of position.
     * The numbering starts with zero.
     *
     * @param nameItem
     *         name of item
    ...
    public void clickOnExpandItemByNameAndPosition(String nameItem, int position) {
        ...
        List<WebElement> expandItemList = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.EXPAND_ITEM_ICON, nameItem))));
        expandItemList.get(position).click();
    }

    /**
     * Click on flag item by name or part of the name and number of position.
     * The numbering starts with zero.
     *
     * @param nameItem
     *         name of item
    ...
    public void setFlagItemByNameAndPosition(String nameItem, int position) {
        ...
        List<WebElement> flagItemList = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.FLAG_ITEM, nameItem))));
    ...
    public boolean itemIsSelectedByNameAndPosition(String nameItem, int position) {
        List<WebElement> itemList = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(String.format(Locators.FLAG_ITEM_INPUT, nameItem))));
    ...
    public int getQuantityLeasedLineInLeftEditor() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(
                By.xpath(Locators.PREVIEW_EDITOR_FRAME)));
        int lineQuantity = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(Locators.LEASED_LINE_LEFT_EDITOR))).size();
        seleniumWebDriver.switchTo().parentFrame();
        return lineQuantity;
    }
    ...
    public int getQuantityLeasedLineInRightEditor() {
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(
                By.xpath(Locators.PREVIEW_EDITOR_FRAME)));
        int lineQuantity = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(Locators.LEASED_LINE_RIGHT_EDITOR))).size();
        seleniumWebDriver.switchTo().parentFrame();
        return lineQuantity;
    }
}
