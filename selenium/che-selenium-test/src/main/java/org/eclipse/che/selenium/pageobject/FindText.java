...
public class FindText {
    ...
    @Inject
    public FindText(SeleniumWebDriver seleniumWebDriver, Loader loader, ActionsFactory actionsFactory) {
    ...
    @FindBy
            (id = Locators.WHOLE_WORD_CHECKLBOX_INP)
    WebElement wholeWordCheckBox;

    @FindBy
            (xpath = Locators.SEARCH_ROOT_CHECKBOX_INP)
    WebElement searchRootCheckBox;

    @FindBy
            (xpath = Locators.FILE_MASK_CHECKBOX_INP)
    WebElement fileMaskCheckBox;

    @FindBy
            (xpath = Locators.FIND_INFO_PANEL)
    WebElement findInfoPanel;

    @FindBy
            (id = Locators.FIND_TAB)
    WebElement findTab;
    ...
    public void waitFindTextMainFormIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.MAIN_FORM)));
    }
    ...
    public void launchFindFormByKeyboard() {
        ...
        action.keyDown(Keys.CONTROL).keyDown(Keys.SHIFT).sendKeys("f").keyUp(Keys.SHIFT).keyUp(Keys.CONTROL).perform();
    }
    ...
    public void waitFindTextMainFormIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.MAIN_FORM)));
    }
    ...
    public void closeFindTextMainForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.CANCEL_BUTTON))).click();
        waitFindTextMainFormIsClosed();
    }
    ...
    public void clickOnSearchButtonMainForm() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(By.id(Locators.SEARCH_BUTTON))).click();
        waitFindTextMainFormIsClosed();
    }
     ...
     *
     * @param text
     *         is text that need to find
     */
    public void typeTextIntoFindField(String text) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.FIND_TEXT_INPUT))).clear();
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.FIND_TEXT_INPUT))).sendKeys(text);
    }
    ...
    public void waitTextIntoFindField(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)webDriver ->
                seleniumWebDriver.findElement(By.id(Locators.FIND_TEXT_INPUT)).getAttribute("value").equals(expText));
    }
    ...
    public void clickOnWholeWordCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.id(Locators.WHOLE_WORD_CHECKLBOX_SPAN))).click();
    }
    ...
    public void waitWholeWordIsSelected() {
        ...
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.id(locator), true));
    }
    ...
    public void waitWholeWordIsNotSelected() {
        String locator = Locators.WHOLE_WORD_CHECKLBOX_INP;
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementSelectionStateToBe(By.id(locator), false));
    }
    ...
    public void clickOnSearchRootCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(Locators.SEARCH_ROOT_CHECKBOX_SPAN))).click();
    }
    ...
    public void waitPathIntoRootField(String path) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)webDriver ->
                seleniumWebDriver.findElement(By.id(Locators.SEARCH_DIR_FIELD)).getAttribute("value").equals(path));
    }
    ...
    public void clickSearchDirectoryBtn() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(By.id(Locators.SEARCH_DIR_BUTTON))).click();
    }
    ...
    public void clickOnFileMaskCheckbox() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(Locators.FILE_MASK_CHECKBOX_SPAN))).click();
    }
    ...
    public void typeTextIntoFileNameFilter(String text) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.FILE_MASK_FIELD))).clear();
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.id(Locators.FILE_MASK_FIELD))).sendKeys(text);
    }
    ...
    public void waitTextIntoFileNameFilter(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until((ExpectedCondition<Boolean>)webDriver ->
                seleniumWebDriver.findElement(By.id(Locators.FILE_MASK_FIELD)).getAttribute("value").equals(expText));
    }
    ...
    public void waitFindInfoPanelIsOpen() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(Locators.FIND_INFO_PANEL)));
    }
    ...
    public void clickHideBtnFindInfoPanel() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.elementToBeClickable(By.xpath(Locators.HIDE_FIND_PANEL))).click();
    ...
    public void waitFindInfoPanelIsClosed() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.invisibilityOfElementLocated(By.id(Locators.FIND_INFO_PANEL)));
    }
    ...
    public void clickFindTab() {
        loader.waitOnClosed();
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(findTab)).click();
        loader.waitOnClosed();
    }
    ...
    public void waitExpectedTextInFindInfoPanel(String expText) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
                (WebDriver driver) -> getTextFromFindInfoPanel().contains(expText));
    }
    ...
    public void selectItemInFindInfoPanel(String item) {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(Locators.ITEM_FIND_PANEL, item)))).click();
    }
     ...
     *
     * @param item
     *         is the name of item into 'Find' info panel
     */
    public void selectItemInFindInfoPanelByDoubleClick(String item) {
        WebElement element = seleniumWebDriver.findElement(By.xpath(String.format(Locators.ITEM_FIND_PANEL, item)));
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(ExpectedConditions.visibilityOf(element));
