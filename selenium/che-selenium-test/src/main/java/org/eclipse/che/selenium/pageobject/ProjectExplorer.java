...
public class ProjectExplorer {
    ...
    public void clickOnProjectExplorerTab() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until
                (ExpectedConditions.visibilityOf(projectExplorerTab)).click();
    }

    /**
     * wait project explorer and click on empty area
     *
     * @param timeOutForWaiting
     *         defined timeout for appearance project explorer page
     */
    ...
    public void waitProjectExplorer(int timeout) {
        new WebDriverWait(seleniumWebDriver, timeout).until(ExpectedConditions.visibilityOf(projectExplorerTree));
    }

    /**
     * wait item in project explorer with path
     * (For Example in project with name:'Test' presents folder 'src' and there is present locates file 'pom.xml' path will be
    ...
    /**
     * wait item in project explorer with customized timeout
     * (For Example in project with name:'Test' presents folder 'src' and there is present locates file 'pom.xpl' path will be
     * next:'Test/src/pom.xml')
     *
     * @param path
     * @param timeout
    ...
    public void waitItem(String path, int timeout) {
        ...
        new WebDriverWait(seleniumWebDriver, timeout).until(ExpectedConditions.presenceOfElementLocated(By.xpath(locator)));
    }
    ...
    public void waitLibraryIsPresent(String libraryName) {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(String.format(
                "//div[@synthetic='true'and @name='%s']", libraryName))));
    }
    ...
    public void waitLibraryIsNotPresent(String libraryName) {
        new WebDriverWait(seleniumWebDriver, 25).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(
                "//div[@synthetic='true'and @name='%s']", libraryName))));
    }


    /**
     * wait visible item in project explorer with path
     * (For Example in project with name:'Test' presents folder 'src' and there is present locates file 'pom.xpl' path will be
     * next:'Test/src/pom.xml')
     *
     * @param path
    ...
    public void waitVisibleItem(String path) {
        ...
        new WebDriverWait(seleniumWebDriver, 20).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locator)));
    }
    ...
    /**
     * wait item in project explorer tree area
     * Note! Items must not repeat (for example: in a project can be some folder. Into each folder can be a file with same name. This
     * method
     * will be track only first item.)
     *
     * @param item
     */
    ...
    /**
     * wait item is not in project explorer tree area
     * Note! Items must not repeat (for example: in a project can be some folder. Into each folder can be a file with same name. This
     * method
     * will be track only first item.)
     *
    ...
    /**
     * select item in project explorer with path
     * For Example in project with name:'Test' presents folder 'src' and there is present locates file 'pom.xpl' path will be
     * next:'Test/src/pom.xml')
     *
     * @param path
     *         full path to project item
     */
    ...
    /**
     * select item in project explorer with path, with user timeout for waiting of the item
     * For Example in project with name:'Test' presents folder 'src' and there is present locates file 'pom.xpl' path will be
     * next:'Test/src/pom.xml')
     *
     * @param path
     *         full path to project item
     * @param timeoutForWaitingItem
     *         user timeout for waiting expected item in the Project Explorer tree
     */
    ...
    /**
     * select item in project explorer with 'name' attribute
     * This is mean if will be two same files in the different folders, will be selected file, that first in the DOM
     *
     * @param item
     */
    ...
    public void waitLibraries(String modulePath) {
        ...
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locator)));
    }
    ...
    public void waitLibrariesIsNotPresent(String modulePath) {
        String locator = "//div [@name='External Libraries' and @project='/" + modulePath + "']";
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(locator)));
    }
    ...
    public void selectLibraries(String modulePath) {
        String locator = "//div [@name='External Libraries' and @project='/" + modulePath + "']";
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locator))).click();
    }
    ...
    public void openItemByPath(String path) {
        ...
        WebElement item = new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC).until(
    ...
    /**
     * open item with double click in visible area
     * (this mean if we have in project explorer several items with same name:
     * in folder /webapp and in folder /src. And the folders are opened,
     * will be opened first item). If we need open item in concrete folder use method openItemByPath
     *
     * @param visibleItem
     */
    public void openItemByVisibleNameInExplorer(String visibleItem) {
        ...
        String locator = String.format("//div[@id='gwt-debug-projectTree']//div[text()='%s']", visibleItem);
        WebElement item = seleniumWebDriver.findElement(
                By.xpath(locator));
        item.click();
        actionsFactory.createAction(seleniumWebDriver).doubleClick(item).perform();
        loader.waitOnClosed();
     ...
     *
     * @param pathToItem
     *         full path to item in the codenvy project explorer
     */
     ...
     *
     * @param pathToFolder
     *         the path to folder (fpr example: TestProject/src/main/test )
     * @param typeFolder
     *         type folder in java project may be simple folder, projectFolder and javaSource folder. We can use this types from
     *         ProjectExlorer.FolderTypes public interface.
     */
    public void waitFolderDefinedTypeOfFolderByPath(String pathToFolder, String typeFolder) {
        String locator = "//div[@path='/" + pathToFolder + "']//*[local-name() = 'svg' and @id='" + typeFolder + "']";
        new WebDriverWait(seleniumWebDriver, LOAD_PAGE_TIMEOUT_SEC)
    ...
    public void waitRemoveItemsByPath(String pathToItem) {
        ...
        new WebDriverWait(seleniumWebDriver, 10)
                .until(ExpectedConditions.not(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(locator))));
    }
    ...
    public void waitContextMenu() {
        new WebDriverWait(seleniumWebDriver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.id(Locators.CONTEXT_MENU_ID)));
    }
    ...
    public void clickOnItemInContextMenu(String item) {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.id(item))).click();
    }
     ...
     *
     * @param path
     *         is the path to the selected item
     */
    ...
    /**
     * launch the 'Refactor Rename' form by keyboard
     * after select a package or Java class
     */
    ...
    /**
     * launch the 'Refactor Move' form by keyboard
     * after select a package or Java class
     */
    ...
    public List<String> getNamesAllProjects() {
        List<WebElement> projects = new WebDriverWait(seleniumWebDriver, 10)
                .until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(Locators.ALL_PROJECTS_XPATH)));
        return projects.stream().map((webElement) -> webElement.getAttribute("name")).collect(Collectors.toList());
    }
    ...
    public void clickOnRefreshTreeButton() {
        new WebDriverWait(seleniumWebDriver, 10).until(ExpectedConditions.visibilityOf(refreshProjectButton)).click();
    }
    ...
    public void clickOnProjectExplorerTabInTheLeftPanel() {
        new WebDriverWait(seleniumWebDriver, REDRAW_UI_ELEMENTS_TIMEOUT_SEC)
                .until(ExpectedConditions.visibilityOf(projectExplorerTabInTheLeftPanel)).click();
    }
     ...
     */
    public void invokeCommandWithContextMenu(String commandsGoal, String pathToItem, String commandName) {
        ...
        try {
            ...
            openContextMenuByPathSelectedItem(pathToItem); // there context menu may not be opened from the first try
        }
    ...
    public void invokeCommandWithContextMenu(String commandsGoal, String pathToItem, String commandName, String machineName) {
        String commandNameLocator = "//tr[@id[contains(.,'%s')]]";
    ...
    /**
     * Expands specified path in project explorer
     * Path given in format like like below:
    ...
    /**
     * Expands specified path in project explorer
     * from defined item (will be try to open from defined item in path)
     * Path given in format like like below:
     * TestProject/src/main/java/org.eclipse.che.examples
     *
     * @param path
    ...
    /**
     * Expands specified path in project explorer and open a file
     * Path given in format like like below:
     * TestProject/src/main/java/org.eclipse.che.examples
     *
     * @param path
    ...
    /**
     * Expands specified path in project explorer
     * from defined item (will be try to open from defined item in path) and open a file
     * Path given in format like like below:
     * TestProject/src/main/java/org.eclipse.che.examples
     *
     * @param path
     *         path for expand
     * @param numItem
     *         number of node from will be opened nex item
     * @param fileName
     */
    ...
    /**
     * Finds a file by name using Navigate to file feature. Expand the tree using  Reveal resource feature
     *
     * @param file
     *         file for serch with Navigate to file feature.
     * @param pathToFile
     */
    public void expandToFileWithRevealResource(String file, String pathToFile) {
        ...
        menu.runCommand(TestMenuCommandsConstants.Edit.EDIT, TestMenuCommandsConstants.Edit.REVEAL_RESOURCE);
        waitItem(pathToFile);
    }
    ...
    /**
     * Invokes special javascript function for 'quick' open the project nodes to the resource (path or file), defined by user.
     *
     * @param absPathToResource
     *         absolute path to necessary file or folder
     */
