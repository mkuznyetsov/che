...
public class Git {
    ...
    @Inject
    public Git(GitStatusBar gitStatusBar,
    ...
    /**
     * send a text and click on OK button
     * on codenvy window
     *
     * @param nameOfBranch
     *         is a name of branch
    ...
    /**
     * select commit by number into history commits list
     * numbers start - 0
     */
    ...
    /**
     * click on the OK button in the 'add to index' form
     * wait the 'add to index' form is closed
     */
    ...
    /**
     * click on the "Cancel' button in tne 'Commit' main form
     * wait the main form is closed
     */
    ...
    /**
     * Wait opening form, type commit message,
     * click on 'Commit' button and wait closing form.
     *
     * @param text
     *         text for commit
     */
    ...
    /**
     * Wait opening form, type commit message,
     * click on 'Push After commit' check-box,
    ...
    /**
     * Wait amend proposal dialog,
     * wait opening form,
     * check 'amend commit' is selected,
     * type new commit message
     * click on 'Commit' button and
     * wait closing form
     *
     * @param text
     *         commit message
    ...
    public void waitAndRunAmendCommitMessage(String text) {
        askDialog.acceptDialogWithText("Nothing to commit, working directory is clean. Would you like to perform amend commit?");
        gitCommit.waitMainFormCommit();
    ...
    /**
     * wait opening form, select 'amend commit'
     * type new commit message
     * click on button OK and
     * wait closing form
     *
     * @param text
    ...
    /**
     * select a revision with specified number into the 'Compare with revision' form
    ...
    /**
     * Wait for item check-box in the 'Git changed files tree panel' in 'Commit' window to be selected.
     *
     * @param itemName
     *         name of the item
     */
    ...
    /**
     * Wait for item check-box in the 'Git changed files tree panel' in 'Commit' window to be unselected.
     *
     * @param itemName
     *         name of the item
     */
    ...
    /**
     * wait opening reference form, type new reference click on checkout button and wait closing the widget
     *
     * @param reference
     ...
     *
     * @param path
     *         - full path to the folder in which a new file will be created (e.g. "MyProject/src/main/webapp")
     * @param fileName
